...
class sale_func(models.Model):
    ...
    amount_excise = fields.Monetary(string='Total Excise',readonly=True, store=True,track_visibility='always',compute='_amount_all',)
...
class SaleOrderFunc(models.Model):
    ...
    @api.onchange('product_id','mrp', 'price_unit', 'product_uom', 'product_uom_qty', 'tax_id')
