...
class sales_ext_invoice(models.Model):
    ...
    pan_num = fields.Char(string="PAN Number", related='partner_id.pan_number', store=True, size=9 )
...
#############################################################
    ...
    amount_excise = fields.Monetary(string='Total Excise', readonly=True,compute='_compute_amount')
